 ...
 */
public class P4M3E1 extends Fragment {
    private Toolbar tb_bottom_next;
    private RadioGroup radioGroupP4M3E1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View fragment = inflater.inflate(R.layout.fragment_pergunta4_modulo3_etapa1,
                container, false);
        ...
        tb_bottom_next.findViewById(R.id.iv_avancar_pergunta).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean ok = AutenticarResposta.validarRadioGroup(radioGroupP4M3E1, "Selecione uma resposta!", getActivity().getApplicationContext());
                if (ok) {
                    ...
                    P5M3E1.setListPergunta(listPerguntaResposta);
                    ((M3E1) getActivity()).trocarPagina(4);
                }
        ...
        tb_bottom_next.findViewById(R.id.iv_voltar_pergunta).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                P3M3E1.setListPergunta(listPerguntaResposta);
                ((M3E1) getActivity()).trocarPagina(2);
            }
        });
