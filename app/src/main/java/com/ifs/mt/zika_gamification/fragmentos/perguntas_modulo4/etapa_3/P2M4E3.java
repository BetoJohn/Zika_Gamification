 ...
 */
public class P2M4E3 extends Fragment {
    private Toolbar tb_bottom_next;
    private RadioGroup radioGroupP2M4E3;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View fragment = inflater.inflate(R.layout.fragment_pergunta2_modulo4_etapa3,
                container, false);
        ...
        tb_bottom_next.findViewById(R.id.iv_avancar_pergunta).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                boolean ok = AutenticarResposta.validarRadioGroup(radioGroupP2M4E3, "Selecione uma resposta!", getActivity().getApplicationContext());
                if (ok) {
                    ...
                    P3M4E3.setListPergunta(listPerguntaResposta);
                    ((M4E3) getActivity()).trocarPagina(2);
                }
        ...
        tb_bottom_next.findViewById(R.id.iv_voltar_pergunta).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                P1M4E3.setListPergunta(listPerguntaResposta);
                ((M4E3) getActivity()).trocarPagina(0);
            }
        });
