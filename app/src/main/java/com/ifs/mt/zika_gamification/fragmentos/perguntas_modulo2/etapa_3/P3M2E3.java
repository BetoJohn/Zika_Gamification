 ...
 */
public class P3M2E3 extends Fragment {
    private Toolbar tb_bottom_next;
    private RadioGroup radioGroupP3M2E3;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View fragment = inflater.inflate(R.layout.fragment_pergunta3_modulo2_etapa3,
                container, false);
        ...
        tb_bottom_next.findViewById(R.id.iv_avancar_pergunta).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean ok = AutenticarResposta.validarRadioGroup(radioGroupP3M2E3, "Selecione uma resposta!", getActivity().getApplicationContext());
                if (ok) {
                    ...
                    P4M2E3.setListPergunta(listPerguntaResposta);
                    ((M2E3) getActivity()).trocarPagina(3);
                }
        ...
        tb_bottom_next.findViewById(R.id.iv_voltar_pergunta).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                P2M2E3.setListPergunta(listPerguntaResposta);
                ((M2E3) getActivity()).trocarPagina(1);
            }
        });
