 ...
 */
public class P3M4E2 extends Fragment {
    private Toolbar tb_bottom_next;
    private RadioGroup radioGroupP3M4E2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View fragment = inflater.inflate(R.layout.fragment_pergunta3_modulo4_etapa2,
                container, false);
        ...
        tb_bottom_next.findViewById(R.id.iv_avancar_pergunta).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean ok = AutenticarResposta.validarRadioGroup(radioGroupP3M4E2, "Selecione uma resposta!", getActivity().getApplicationContext());
                if (ok) {
        ...
        tb_bottom_next.findViewById(R.id.iv_voltar_pergunta).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                P2M4E2.setListPergunta(listPerguntaResposta);
                ((M4E2) getActivity()).trocarPagina(1);
            }
        });
