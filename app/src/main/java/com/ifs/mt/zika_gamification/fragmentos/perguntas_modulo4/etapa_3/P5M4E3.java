...
import com.ifs.mt.zika_gamification.telas.treinamento_modulo4.etapa_3.P5M4E3_Video;
 ...
 */
public class P5M4E3 extends Fragment {
    private Toolbar tb_bottom_next;
    private TextView textViewResultado;
    private RadioGroup radioGroupP5M4E3;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View fragment = inflater.inflate(R.layout.fragment_pergunta5_modulo4_etapa3,
                container, false);
        ...
        imageViewPlay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getActivity(), P5M4E3_Video.class));
            }
        });
        ...
        tb_bottom_next.findViewById(R.id.iv_concluir).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean ok = AutenticarResposta.validarRadioGroup(radioGroupP5M4E3, "Selecione uma resposta!", getActivity().getApplicationContext());
                if (ok) {
                   /* Toast.makeText(getActivity().getApplicationContext(), "Concluir", Toast.LENGTH_SHORT).show();*/
                    ...
                    if (userUid != null) {
                        ...
                        System.out.println("Experiencia atualizada no P5M2E3: "+statusM.getExperiencia());
                        statusM.setModulo_04_status(true);
                        //Atualização local
                        ...
                        updates.put("modulo_04_status", statusM.isModulo_04_status());
                        //Atualização remota
        ...
        tb_bottom_next.findViewById(R.id.iv_voltar_pergunta).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((M4E2) getActivity()).trocarPagina(3);
            }
        });
