 ...
 */
public class P3M3E1 extends Fragment {
    private Toolbar tb_bottom_next;
    private RadioGroup radioGroupP3M3E1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View fragment = inflater.inflate(R.layout.fragment_pergunta3_modulo3_etapa1,
                container, false);
        ...
        tb_bottom_next.findViewById(R.id.iv_avancar_pergunta).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean ok = AutenticarResposta.validarRadioGroup(radioGroupP3M3E1, "Selecione uma resposta!", getActivity().getApplicationContext());
                if (ok) {
                    ...
                    ((M3E1) getActivity()).trocarPagina(3);
                }
        ...
        tb_bottom_next.findViewById(R.id.iv_voltar_pergunta).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                P2M3E1.setListPergunta(listPerguntaResposta);
                ((M3E1) getActivity()).trocarPagina(1);
            }
        });
