package com.ifs.mt.zika_gamification.telas.treinamento_modulo2.etapa_3;
...
public class M2E3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tb_perguntas.findViewById(R.id.iv_voltar).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(M2E3.this);
                ...
                alertDialog.setPositiveButton("Sair", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                       startActivity(new Intent(M2E3.this, M2.class));
                    }
                });
