package com.ifs.mt.zika_gamification.telas.treinamento_modulo3.etapa_1;
...
import com.ifs.mt.zika_gamification.fragmentos.perguntas_modulo3.etapa_1.P1M3E1;
import com.ifs.mt.zika_gamification.fragmentos.perguntas_modulo3.etapa_1.P2M3E1;
import com.ifs.mt.zika_gamification.fragmentos.perguntas_modulo3.etapa_1.P3M3E1;
import com.ifs.mt.zika_gamification.fragmentos.perguntas_modulo3.etapa_1.P4M3E1;
import com.ifs.mt.zika_gamification.fragmentos.perguntas_modulo3.etapa_1.P5M3E1;
import com.ifs.mt.zika_gamification.telas.treinamento_modulo3.M3;

import java.util.ArrayList;
import java.util.List;

public class M3E1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tb_perguntas.findViewById(R.id.iv_voltar).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(M3E1.this);
                ...
                alertDialog.setPositiveButton("Sair", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                       startActivity(new Intent(M3E1.this, M3.class));
                    }
                });
        ...
        fragments.add(new P1M3E1());
        fragments.add(new P2M3E1());
        fragments.add(new P3M3E1());
        fragments.add(new P4M3E1());
        fragments.add(new P5M3E1());
