...
public class P5M2E3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View fragment = inflater.inflate(R.layout.fragment_pergunta5_modulo2_etapa3,
                container, false);
                ...
                if (ok) {
                   /* Toast.makeText(getActivity().getApplicationContext(), "Concluir", Toast.LENGTH_SHORT).show();*/
                    ...
                    if (userUid != null) {
                        ...
                        statusM.setModulo_02_status(true);
                        //Atualização local
                        ...
                        updates.put("modulo_02_status", statusM.isModulo_02_status());
                        //Atualização remota
