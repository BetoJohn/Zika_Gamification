 ...
 */
public class P1M3E1 extends Fragment {
    private Toolbar tb_bottom_next;
    private RadioGroup radioGroupP1M3E1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View fragment = inflater.inflate(R.layout.fragment_pergunta1_modulo3_etapa1,
                container, false);
        ...
        tb_bottom_next.findViewById(R.id.iv_avancar_pergunta).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean ok = AutenticarResposta.validarRadioGroup(radioGroupP1M3E1, "Selecione uma resposta!", getActivity().getApplicationContext());
                if (ok) {
