package com.ifs.mt.zika_gamification.fragmentos.perguntas_modulo4.etapa_1;
...
import com.ifs.mt.zika_gamification.telas.treinamento_modulo2.etapa_1.P5M2E1_Video;
...
import com.ifs.mt.zika_gamification.telas.treinamento_modulo4.etapa_1.P5M4E1_Video;
 ...
 */
public class P5M4E1 extends Fragment {
    private Toolbar tb_bottom_next;
    private TextView textViewResultado;
    private RadioGroup radioGroupP5M4E1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imageViewPlay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getActivity(), P5M4E1_Video.class));
            }
        });
        ...
        tb_bottom_next.findViewById(R.id.iv_concluir).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    boolean ok = AutenticarResposta.validarRadioGroup(radioGroupP5M4E1, "Selecione uma resposta!", getActivity().getApplicationContext());
                    if (ok) {
                        Util util = new Util();
                        ...
                        modulo.setModulo_Nome("M4");

                        etapa = new EtapaM();
                        etapa.setEtapa_Nome("E1M4");
                        ...
                        dialogButton.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                dialog.dismiss();
                                startActivity(new Intent(getActivity(), M4.class));
                            }
                        });
        ...
        tb_bottom_next.findViewById(R.id.iv_voltar_pergunta).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                P4M4E1.setListPergunta(listPerguntaResposta);
                ((M4E1) getActivity()).trocarPagina(3);
            }
        });
