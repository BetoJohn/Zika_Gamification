package com.ifs.mt.zika_gamification.telas.treinamento_modulo4;
...
import com.ifs.mt.zika_gamification.adapter.EtapasM2RecyclerViewAdapter;
import com.ifs.mt.zika_gamification.adapter.EtapasM4RecyclerViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tb_etapa.findViewById(R.id.iv_voltar).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(M4.this, Treinamento.class));
            }
        });
        ...
        EtapasM4RecyclerViewAdapter rcAdapter = new EtapasM4RecyclerViewAdapter(M4.this);
