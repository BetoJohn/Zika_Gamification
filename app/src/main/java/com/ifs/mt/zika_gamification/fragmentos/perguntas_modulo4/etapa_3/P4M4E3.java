 ...
 */
public class P4M4E3 extends Fragment {
    private Toolbar tb_bottom_next;
    private RadioGroup radioGroupP4M4E3;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View fragment = inflater.inflate(R.layout.fragment_pergunta4_modulo4_etapa3,
                container, false);
        ...
        tb_bottom_next.findViewById(R.id.iv_avancar_pergunta).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean ok = AutenticarResposta.validarRadioGroup(radioGroupP4M4E3, "Selecione uma resposta!", getActivity().getApplicationContext());
                if (ok) {
                    ...
                    P5M4E3.setListPergunta(listPerguntaResposta);
                    ((M4E3) getActivity()).trocarPagina(4);
                }
