 ...
 */
public class P4M2E2 extends Fragment {
    private Toolbar tb_bottom_next;
    private RadioGroup radioGroupP4M2E2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View fragment = inflater.inflate(R.layout.fragment_pergunta4_modulo2_etapa2,
                container, false);
        ...
        tb_bottom_next.findViewById(R.id.iv_avancar_pergunta).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean ok = AutenticarResposta.validarRadioGroup(radioGroupP4M2E2, "Selecione uma resposta!", getActivity().getApplicationContext());
                if (ok) {
                    ...
                    P5M2E2.setListPergunta(listPerguntaResposta);
        ...
        tb_bottom_next.findViewById(R.id.iv_voltar_pergunta).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                P3M2E2.setListPergunta(listPerguntaResposta);
