package com.ifs.mt.zika_gamification.telas.treinamento_modulo2.etapa_2;
...
public class M2E2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tb_perguntas.findViewById(R.id.iv_voltar).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(M2E2.this);
                ...
                alertDialog.setPositiveButton("Sair", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                       startActivity(new Intent(M2E2.this, M2.class));
                    }
                });
