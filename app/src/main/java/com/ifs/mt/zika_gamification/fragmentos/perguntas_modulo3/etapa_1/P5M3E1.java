package com.ifs.mt.zika_gamification.fragmentos.perguntas_modulo3.etapa_1;
...
import com.ifs.mt.zika_gamification.telas.treinamento_modulo3.etapa_1.P5M3E1_Video;
 ...
 */
public class P5M3E1 extends Fragment {
    private Toolbar tb_bottom_next;
    private TextView textViewResultado;
    private RadioGroup radioGroupP5M3E1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View fragment = inflater.inflate(R.layout.fragment_pergunta5_modulo3_etapa1,
                container, false);
        ...
        imageViewPlay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getActivity(), P5M3E1_Video.class));
            }
        });
        ...
        tb_bottom_next.findViewById(R.id.iv_concluir).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    boolean ok = AutenticarResposta.validarRadioGroup(radioGroupP5M3E1, "Selecione uma resposta!", getActivity().getApplicationContext());
                    if (ok) {
                        Util util = new Util();
                        ...
                        if (userUid != null) {
                            ...
                            System.out.println("Experiencia no P5M3E1: "+experiencia);
                            statusM.setExperiencia( experiencia + statusBanco.getExperiencia());
                            System.out.println("Experiencia atualizada no P5M3E1: "+statusM.getExperiencia());
                            //Atualização local
                        ...
                        dialogButton.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                dialog.dismiss();
                                startActivity(new Intent(getActivity(), M3.class));
                            }
                        });
        ...
        tb_bottom_next.findViewById(R.id.iv_voltar_pergunta).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                P4M3E1.setListPergunta(listPerguntaResposta);
