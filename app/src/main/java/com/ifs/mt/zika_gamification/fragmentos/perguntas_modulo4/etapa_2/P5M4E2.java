 ...
 */
public class P5M4E2 extends Fragment {
    private Toolbar tb_bottom_next;
    private TextView textViewResultado;
    private RadioGroup radioGroupP5M4E2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View fragment = inflater.inflate(R.layout.fragment_pergunta5_modulo4_etapa2,
                container, false);
        ...
        tb_bottom_next.findViewById(R.id.iv_concluir).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean ok = AutenticarResposta.validarRadioGroup(radioGroupP5M4E2, "Selecione uma resposta!", getActivity().getApplicationContext());
                if (ok) {
                   /* Toast.makeText(getActivity().getApplicationContext(), "Concluir", Toast.LENGTH_SHORT).show();*/
                    ...
                    if (userUid != null) {
                        ...
                        System.out.println("Experiencia no P5M4E2: "+experiencia);
                        statusM.setExperiencia( experiencia + statusBanco.getExperiencia());
                        System.out.println("Experiencia atualizada no P5M4E2: "+statusM.getExperiencia());
                        //Atualização local
        ...
        tb_bottom_next.findViewById(R.id.iv_voltar_pergunta).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                P4M4E2.setListPergunta(listPerguntaResposta);
