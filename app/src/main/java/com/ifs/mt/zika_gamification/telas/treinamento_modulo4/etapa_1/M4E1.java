package com.ifs.mt.zika_gamification.telas.treinamento_modulo4.etapa_1;
...
import com.ifs.mt.zika_gamification.fragmentos.perguntas_modulo4.etapa_1.P1M4E1;
import com.ifs.mt.zika_gamification.fragmentos.perguntas_modulo4.etapa_1.P2M4E1;
import com.ifs.mt.zika_gamification.fragmentos.perguntas_modulo4.etapa_1.P3M4E1;
import com.ifs.mt.zika_gamification.fragmentos.perguntas_modulo4.etapa_1.P4M4E1;
import com.ifs.mt.zika_gamification.fragmentos.perguntas_modulo4.etapa_1.P5M4E1;
import com.ifs.mt.zika_gamification.telas.treinamento_modulo4.M4;

import java.util.ArrayList;
import java.util.List;

public class M4E1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tb_perguntas.findViewById(R.id.iv_voltar).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(M4E1.this);
                ...
                alertDialog.setPositiveButton("Sair", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                       startActivity(new Intent(M4E1.this, M4.class));
                    }
                });
                alertDialog.show();
        ...
        fragments.add(new P1M4E1());
        fragments.add(new P2M4E1());
        fragments.add(new P3M4E1());
        fragments.add(new P4M4E1());
        fragments.add(new P5M4E1());
